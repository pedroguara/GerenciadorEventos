          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: [
                ...
                DropdownMenuItem(
                    value: 'desc', child: Text('Data Descendente')),
              ],
...
class _EditEventPageState extends State<EditEventPage> {
  ...
  void initState() {
    ...
    _contractorController =
        TextEditingController(text: widget.event.contractor);
    _ticketsSoldController =
        TextEditingController(text: widget.event.ticketsSold.toString());
